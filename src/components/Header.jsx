...
export default function Header() {
  ...
  return (
    <header style={{ position:'sticky', top:0, zIndex:100, height:'80px', background: scrolled ? 'rgba(17,24,39,.98)' : 'rgba(17,24,39,.92)', backdropFilter:'blur(20px)', borderBottom:`1px solid ${scrolled ? 'rgba(41,90,158,.4)' : 'rgba(41,90,158,.15)'}`, transition:'all .3s' }}>
      <div className="container" style={{ height:'100%', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'.4rem' }}>
          <button className="menu-toggle" onClick={() => setMobileOpen(o=>!o)} style={{ display:'none', background:'none', border:'none', cursor:'pointer', color:'#fff', padding:'.35rem' }}>
