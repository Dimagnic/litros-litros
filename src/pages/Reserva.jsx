      ...
      <div className="container" style={{ padding:'3rem 1.5rem 5rem', maxWidth:'600px' }}>
        ...
        <div style={{ background:'var(--card)', border:'1px solid var(--border-s)', borderRadius:'var(--radius-lg)', padding:'2rem' }}>
          ...
          <button onClick={handleReservar} style={{
            ...
            boxShadow:'0 4px 20px rgba(180,30,10,.4)',
          }}
            onMouseEnter={e => { e.currentTarget.style.background='var(--primary-l)'; e.currentTarget.style.boxShadow='0 6px 28px rgba(180,30,10,.55)' }}
            onMouseLeave={e => { e.currentTarget.style.background='var(--primary)'; e.currentTarget.style.boxShadow='0 4px 20px rgba(180,30,10,.4)' }}
          >
